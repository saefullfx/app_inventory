...
<section class="content-header">
    <h1>
        Po Sparepart Dari Customer
        <small>data list </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="http://localhost/app_inventory/admin/transaksi/po_sementara">Po Sparepart Dari Customer</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="pull-right"><a href="<?php echo base_url().'index.php/admin/transaksi/add_po_sementara'?>" class="btn  btn-success"  ><span class="fa fa-plus"></span> </a>
