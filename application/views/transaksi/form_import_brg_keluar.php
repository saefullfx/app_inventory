...
<body>
  <h3>Form Import Sparepart Keluar</h3>
  <hr>
  
  <a href="<?php echo base_url("excel/format_sparepart_keluar.xlsx"); ?>">Download Format</a>
  <br>
  <br>
  
  <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
  <form method="post" action="<?php echo base_url("index.php/admin/transaksi/form_import_brg_keluar"); ?>" enctype="multipart/form-data">
    <!-- 
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    echo "<form method='post' action='".base_url("index.php/admin/transaksi/import_brg_keluar")."'>";
    ...
    foreach($sheet as $row){ 
      ...
      if($kode_barang == "" && $status_id == "" && $customer_id == "" && $jumlah == "" && $nomor_po == "" && $tanggal_order == ""  && $nomor_surat_jalan == "" && $tanggal == "" && $keterangan == "")
      ...
      if($numrow > 1){
        ...
        $tanggal_order_td = ( ! empty($tanggal_order))? "" : " style='background: #E07171;'"; // Jika Alamat kosong, beri warna merah
        ...
        if($kode_barang == "" or $status_id == "" or $customer_id == "" or $jumlah == "" or $nomor_po == "" or $tanggal_order == ""   or $nomor_surat_jalan == "" or $tanggal == "" or $keterangan == ""){
    ...
    <?php
      ...
      echo "<a href='".base_url("index.php/admin/transaksi/barang_keluar")."'>Cancel</a>";
    }
