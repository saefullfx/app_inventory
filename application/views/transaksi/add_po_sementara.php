                    ...
                    <!--div class="form-group">
                        ...
                        <div class="col-xs-9">
                          <!-- <?php
                            ...
                            ?> -->
                            <!--<select class="form-control select2" name="type_id" id="type"  style="width:335px;" required="">
                            <option value="">Please Select</option>
                            <?php
                            foreach ($get_jenis as $prov) {
                                ?>
                                <option <?php //echo $get_jenis_selected == $prov->id ? 'selected="selected"' : '' ?>
                                    value="<?php //echo $prov->id ?>"><?php echo $prov->nama_jenis ?></option>
                                <?php
                           // }
                            //?>
                        </select>
                     ...
                     <!--<div class="form-group">
                       <label class="control-label col-xs-3" >Part Number</label>
                        <div class="col-xs-9">
                        <select class="form-control select2" name="kode_barang" id="kode_barang"  style="width:335px;" required>
                            <option value="">Please Select</option>
                            <?php
                          //  foreach ($get_part_number as $kot) {
                                ?>
                                //di sini kita tambahkan class berisi id provinsi
                                <option <?php //echo $get_part_number_selected == $kot->jenis_id ? 'selected="selected"' : '' ?>
                                    class="<?php //echo $kot->jenis_id ?>" value="<?php //echo $kot->kode_barang ?>"><?php //echo $kot->kode_barang ?></option>
                                <?php
                            }
                            ?>
                  <!--      </select>
                    ...
                    <a href="<?php echo base_url().'index.php/admin/transaksi/po_sementara'?>" class="btn btn-danger"> Batal </a>
