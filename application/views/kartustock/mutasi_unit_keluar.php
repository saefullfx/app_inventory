...
<section class="content-header">
    ...
    <form method="get" action="">
        ...
        <div id="form-nama_unit">
            ...
            <select name="nama_unit">
                <option value="">Pilih</option>
                <?php
                    foreach ($option_nama_rekap_unit_keluar as $key) {
        ...
        <div id="form-tahun">
            ...
            <select name="tahun">
                <option value="">Pilih</option>
                <?php
                foreach($option_tahun_rekap_unit_keluar as $data){ // Ambil data tahun dari model yang dikirim dari controller
        ...
        <a href="<?php echo base_url('index.php/kartustock/mutasi_unit_keluar'); ?>">Reset Filter</a>
    </form>
    <hr />
   ...
   <table id="" class="table table-bordered table-hover">        
    ...
    <?php 
    $no++;
    $total+=$data->unit_keluar;
            }
     ?>  
         <tr font-style: bold;>
             <td colspan="4" align="center" ><b>Total Unit Keluar</b></td>
