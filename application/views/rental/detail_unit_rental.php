...
<section class="content-header">
    <h1>
        Data Detail Rental Unit
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">detail unit rental</a></li>
...
<div class="box">
     <div class="box-header">
                  ...
                  <div class="pull-right"><a href="<?php echo base_url().'index.php/barang/rental/unit_rental'?>" class="btn  btn-info"  >Kembali </a></div>
                </div><!-- /.box-header -->
...
<tbody>
    <?php
    if( ! empty($detail_unit_rental)){
        $no = 1;
        foreach($detail_unit_rental as $data){
