...
<section class="content-header">
    <h1>
        Data Detail PO Unit Masuk
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">detail PO</a></li>
...
<div class="box">
     <div class="box-header">
                  ...
                  <div class="pull-right"><a href="<?php echo base_url().'index.php/report/stock_unit'?>" class="btn  btn-info"  >Kembali </a></div>
                </div><!-- /.box-header -->
...
<tbody>
    <?php
    if( ! empty($detail_po_unit_masuk)){
        $no = 1;
        foreach($detail_po_unit_masuk as $data){
            $tgl = date('d-m-Y', strtotime($data->tanggal_po_customer));
           ?> 
            <tr> 
                <td><?php echo $no++ ?></td>          
                ...
                <td><?php echo $tgl ?></td>
                <td><?php echo $data->po_customer ?></td>
