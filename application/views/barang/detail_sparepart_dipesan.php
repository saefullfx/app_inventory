...
<div class="box">
     <div class="box-header">
                  ...
                  <div class="pull-right"><a href="<?php echo base_url().'index.php/report/rekap_all'?>" class="btn  btn-info"  >Kembali </a></div>
                </div><!-- /.box-header -->
...
<tbody>
    <?php
    if( ! empty($detail_sparepart_dipesan)){
        $no = 1;
        foreach($detail_sparepart_dipesan as $data){
           ...
           ?> 
            <tr> 
                ...
                <td><?php echo $data->jumlah_parsial?></td>
                <td><?php echo $data->SISA_KIRIM?></td>
