...
<section class="content-header">
    <h1>
        Data Detail PO Unit Ke Supplier
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Unit On going</a></li>
...
<tbody>
    <?php
    if( ! empty($detail_po_unit_keluar)){
        $no = 1;
        foreach($detail_po_unit_keluar as $data){
            ?>
                ...
                <td><?php echo $data->sisa_masuk ?></td>
