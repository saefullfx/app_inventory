...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="<?php echo base_url('kolam/ionicons-2.0.1/css/ionicons.min.css') ?>" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        ...
        <link href="<?php echo base_url('kolam/AdminLTE-2.0.5/dist/css/skins/_all-skins.min.css') ?>" rel="stylesheet" type="text/css" />
