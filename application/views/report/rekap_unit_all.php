...
<div class="box">
    ...
    <form method="get" action="">
        ...
        <button class="btn-info" type="submit">Tampilkan</button> ||
        <a class="btn-danger" href="<?php echo base_url('index.php/report/rekap_unit_all'); ?>">Reset Filter</a>
    </form>
    <hr />
 ...
 <div class="box-body">
    ...
    <tr>
                    ...
                    <th>Type Unit</th>
                    <th>Model Unit</th>                       
                    <th align="center">PO Unit Ke Supplier</th>    
                   <!--  <th align="center">PO Unit Dari Customer</th>                                           
                    <th align="center">Stock</th>
                    <th align="center">Open Stock</th>                -->                             
    </tr>
</thead>
<tbody>
    <?php
    if( ! empty($report)){
        ...
        <td align="center"><a href="<?php echo site_url('report/detail_po_unit_keluar/').$data->model_id?>"><?php echo $data->baru_masuk ?></a></td>
       ...
       <!--  <td align="center"><a href="<?php echo site_url('report/detail_unit_stock/').$data->model_id?>"><?php echo $data->total?></a></td> -->
