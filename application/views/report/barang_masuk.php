...
<section class="content-header">
    <h1>
        Laporan Sparepart Masuk
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">laporan</a></li>
        <li class="active">Sparepart masuk</li>
    </ol>
</section>
...
<div class="box">
 ...
 <form method="get" action="">
        ...
        <div id="form-tahun">
         ...
         <div id="form-kode_barang">
            ...
            <select name="kode_barang">
                <option value="">Pilih</option>
                <?php
                    foreach ($option_kode_barangmasuk as $key) {
        ...
        <a href="<?php echo base_url('index.php/report/barang_masuk'); ?>">Reset Filter</a>
    </form>
    <hr />
...
?>
    ...
    $(document).ready(function(){ // Ketika halaman selesai di load
        ...
        $('#form-tanggal, #form-bulan, #form-tahun, #form-kode_barang, #form-kode_barang2, #form-tanggal2').hide(); // Sebagai default kita sembunyikan form filter tanggal, bulan & tahunnya

        $('#filter').change(function(){ // Ketika user memilih filter
            if($(this).val() == '1'){ // Jika filter nya 1 (per tanggal)
                $('#form-bulan, #form-tahun, #kode_barang').hide(); // Sembunyikan form bulan dan tahun
                $('#form-tanggal').show(); // Tampilkan form tanggal
            }else if($(this).val() == '2'){ // Jika filter nya 2 (per bulan)
                $('#form-tanggal, #kode_barang').hide(); // Sembunyikan form tanggal
                $('#form-bulan, #form-tahun').show(); // Tampilkan form bulan dan tahun
            }else if($(this).val() == '3'){ // Jika filternya 3 (per tahun)
                $('#form-tanggal, #form-bulan, #kode_barang').hide(); // Sembunyikan form tanggal dan bulan
                ...
                $('#form-tanggal, #form-bulan, #form-tahun, #kode_barang').hide(); // Sembunyikan form tanggal dan bulan
                $('#form-kode_barang2, #form-tanggal2').show(); // Tampilkan form tahun   
            }

            $('#form-tanggal input, #form-tanggal2 input, #form-bulan select, #form-tahun select, #form-kode_barang select, #form-kode_barang2 select').val(''); // Clear data pada textbox tanggal, combobox bulan & tahun
        })
    })
    </script>
