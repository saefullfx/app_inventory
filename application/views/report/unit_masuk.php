...
<div class="box">
    ...
    <form method="get" action="">
        ...
        <select name="filter" id="filter">
            ...
            <option value="5">Per Type Unit</option>
        ...
        <a href="<?php echo base_url('index.php/report/unit_masuk'); ?>">Reset Filter</a>
    </form>
    <hr />
 ...
 <div class="box-body">
    ...
    if( ! empty($report)){
        ...
        foreach($report as $data){
            ...
            //      echo "<td><small class='label label-danger'>DIPESAN</small></td>";
            // }else{
            //     echo "<td><small class='label label-info'>STOCK</small></td>";
            // }
