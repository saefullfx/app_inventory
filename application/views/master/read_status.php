            ...
            <form class="form-horizontal">
                <div class="modal-body">               
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama status</label>
                        <div class="col-xs-9">
                            <input name="nama_status" id="nama_status" class="form-control" type="text" placeholder="Nama lokasi" style="width:335px;" required>
                        </div>
                    </div>  
            ...
            <form class="form-horizontal">
                <div class="modal-body">                     
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama status</label>
                        <div class="col-xs-9">
                            <input name="nama_statusedit" id="nama_status2" class="form-control" type="text"  style="width:335px;" required>
                        </div>
                    </div>  
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="alert alert-warning"><p>Apakah Anda yakin mau menghapus status ini?</p></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        tampil_data_status();   //pemanggilan fungsi tampil.
        ...
        function tampil_data_status(){
            $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>page/data_status',
                async : false,
                dataType : 'json',
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('page/get_lokasi')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id, nama_status){
                        $('#ModalEdit').modal('show');
                        $('[name="idedit"]').val(data.id);
                        $('[name="nama_statusedit"]').val(data.nama_status);
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('page/save_status')?>",
                dataType : "JSON",
                data : {id:id , nama_status:nama_status},
                success: function(data){
                    $('[name="id"]').val("");
        ...
        $('#btn_update').on('click',function(){
            var id=$('#id2').val();
            var nama_status=$('#nama_status2').val();
        ...
        $('#btn_delete').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('page/delete_status')?>",
            dataType : "JSON",
                    data : {id:id},
                    success: function(data){
