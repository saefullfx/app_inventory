...
<section class="content-header">
    <h1>
        Customer
        <small>data list customer</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <section class="content">
             <div class="row">
                <div class="col-md-12">
                    ...
                    <h4 alignt="center"><i class="icon fa fa-info"></i> Info!</h4>
                    <h5 alignt="cenetr">Sebelum input baru data Customer, silahkan cek terlebih dahulu apakah data sudah terdaftar atau belum.</h5>
                  </div>
              </div>
            </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Customer</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="nama_customer" name="nama_customer" placeholder="Nama Customer" class="form-control" required="true" value="" type="text" style="width:335px;"></div>
                            </div>
                         </div>
                         <div class="form-group">
            ...
            <form class="form-horizontal">
                <div class="modal-body">                     
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Customer</label>
                        <div class="col-xs-9">
                            <input name="nama_customeredit" id="nama_customer2" class="form-control" type="text"  style="width:335px;" required>
                        </div>
                    </div>  
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="alert alert-warning"><p>Apakah Anda yakin mau menghapus customer ini?</p></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        tampil_data_customer();   //pemanggilan fungsi tampil.
        ...
        function tampil_data_customer(){
            $.ajax({
                type  : 'GET',
                url   : '<?php echo base_url()?>index.php/page/data_customer',
                async : false,
                dataType : 'json',
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('index.php/page/get_customer')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id, nama_customer, telepon, alamat, keterangan){
                        $('#ModalEdit').modal('show');
                        $('[name="idedit"]').val(data.id);
                        $('[name="nama_customeredit"]').val(data.nama_customer);
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/page/save_customer')?>",
                dataType : "JSON",
                data : {id:id , nama_customer:nama_customer, telepon:telepon, alamat:alamat, keterangan:keterangan},
                success: function(data){
                    $('[name="id"]').val("");
        ...
        $('#btn_update').on('click',function(){
            var id=$('#id2').val();
            var nama_customer=$('#nama_customer2').val();
           ...
           /* var nabar=$('#nama_barang2').val();
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/page/update_customer')?>",
                dataType : "JSON",
                data : {id:id, nama_customer:nama_customer, telepon:telepon, alamat:alamat, keterangan:keterangan},
                success: function(data){
                    $('[name="idedit"]').val("");
                    $('[name="nama_customeredit"]').val("");
        ...
        $('#btn_delete').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('index.php/page/delete_customer')?>",
            dataType : "JSON",
                    data : {id:id},
                    success: function(data){
